...
#include "RAInventoryStateSettling.generated.h"

UCLASS()
class URAInventoryStateSettling : public URAInventoryState
{
	GENERATED_BODY()
...
public:
	URAInventoryStateSettling(const FObjectInitializer& ObjectInitializer);
